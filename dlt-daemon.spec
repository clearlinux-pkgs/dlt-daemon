...
Version  : 2.18.6
Release  : 12
URL      : https://github.com/GENIVI/dlt-daemon/archive/v2.18.6/dlt-daemon-2.18.6.tar.gz
Source0  : https://github.com/GENIVI/dlt-daemon/archive/v2.18.6/dlt-daemon-2.18.6.tar.gz
...
%prep
%setup -q -n dlt-daemon-2.18.6
cd %{_builddir}/dlt-daemon-2.18.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611251896
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/dlt-daemon-2.18.6/COPYING %{buildroot}/usr/share/package-licenses/dlt-daemon/dfe271856a9bc13ac767a004bae74373048066c5
cp %{_builddir}/dlt-daemon-2.18.6/LICENSE %{buildroot}/usr/share/package-licenses/dlt-daemon/0a5d7250eb460d165c2213af55db0b20c3aa8c35
cp %{_builddir}/dlt-daemon-2.18.6/gtest-1.7.0/LICENSE %{buildroot}/usr/share/package-licenses/dlt-daemon/5a2314153eadadc69258a9429104cd11804ea304
cp %{_builddir}/dlt-daemon-2.18.6/src/core_dump_handler/cityhash_c/COPYING %{buildroot}/usr/share/package-licenses/dlt-daemon/345b50630701ae570b0bdcdb186f66408ea8936c
pushd clr-build
%make_install
popd
