...
%prep
%setup -q -n dlt-daemon-2.18.7
cd %{_builddir}/dlt-daemon-2.18.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625031845
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/dlt-daemon-2.18.7/COPYING %{buildroot}/usr/share/package-licenses/dlt-daemon/dfe271856a9bc13ac767a004bae74373048066c5
cp %{_builddir}/dlt-daemon-2.18.7/LICENSE %{buildroot}/usr/share/package-licenses/dlt-daemon/0a5d7250eb460d165c2213af55db0b20c3aa8c35
cp %{_builddir}/dlt-daemon-2.18.7/debian/copyright %{buildroot}/usr/share/package-licenses/dlt-daemon/ecb04f0f3ecd2f118c6838701a27c2adf7840dc8
cp %{_builddir}/dlt-daemon-2.18.7/gtest-1.7.0/LICENSE %{buildroot}/usr/share/package-licenses/dlt-daemon/5a2314153eadadc69258a9429104cd11804ea304
cp %{_builddir}/dlt-daemon-2.18.7/src/core_dump_handler/cityhash_c/COPYING %{buildroot}/usr/share/package-licenses/dlt-daemon/345b50630701ae570b0bdcdb186f66408ea8936c
pushd clr-build
%make_install
popd
...
/usr/lib64/cmake/automotive-dlt/automotive-dlt-config.cmake
/usr/lib64/cmake/automotive-dlt/automotive-dlt-targets-relwithdebinfo.cmake
/usr/lib64/cmake/automotive-dlt/automotive-dlt-targets.cmake
/usr/lib64/libdlt.so
...
/usr/share/package-licenses/dlt-daemon/ecb04f0f3ecd2f118c6838701a27c2adf7840dc8
